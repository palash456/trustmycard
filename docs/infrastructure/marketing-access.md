...
| **TikTok**           | `ttclid`         | **No** — Events API sends events _to_ TikTok; does not verify inbound clicks  | [Events API](https://business-api.tiktok.com/open_api/v1.3/event/track/) (attribution only)                                           | —                                                                                                                                                                               | `NO_OFFICIAL_TTCLID_VERIFICATION_API` → decoy                   | —                                                                                         |
