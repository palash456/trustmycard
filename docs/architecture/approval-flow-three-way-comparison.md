...
- **Competitor** still leads on *calling* energy in the live path, but the captured HAR proves **`already_sent` ≠ success** on a 0-TRX wallet.
...
*Competitor data sourced from [tron-approval-flow-comparison.md](./tron-approval-flow-comparison.md) (HAR-validated). TMC Current reflects `frontend/wallet-sdk/src/approval/` and `backend/src/modules/resources/` as of 2026-07-29.*
