    ...
    <>
            ...
            <div className="flex flex-col items-center text-center lg:items-start lg:text-left">
              ...
              <Reveal delay={240} className="w-full sm:w-auto">
                <div className="mt-7 flex w-full flex-col gap-3 sm:mt-8 sm:flex-row sm:flex-wrap sm:items-center sm:gap-4">
                  <div id="connect-primary">{renderConnectButton("hero", "Issue Card", "hero")}</div>
                  <button
                    type="button"
                ...
                <div className="mt-7 grid grid-cols-2 justify-items-center gap-y-3 sm:mt-8 sm:flex sm:flex-row sm:flex-wrap sm:gap-x-8 lg:items-start">
                  {["No KYC", "Instant Approval", "Zero Annual Fee"].map((item, index) => (
                    ...
                    >
                      ...
                      <span className="text-sm font-medium text-[#6A6D81] sm:text-base">{item}</span>
                    </div>
                  ))}
                </div>
              </Reveal>
      ...
      <section className="border-t border-[#ECECEF] bg-[#F9FAFB] py-10 sm:py-16 lg:py-20">
        <div className="mx-auto w-full max-w-5xl px-4 sm:px-6 lg:px-8">
          <Reveal>
            <h2 className="text-center text-sm font-medium text-[#6A6D81] sm:text-base">Our Backers</h2>
          </Reveal>
            ...
            <Reveal delay={120} className="flex w-full items-center justify-center lg:min-h-full">
              <div className="relative mx-auto w-full max-w-[400px] sm:max-w-[460px] lg:max-w-[480px]">
                <div className="grid grid-cols-2 gap-7 sm:gap-8">
                  {[
                    { name: "Tron", rate: "Up to 3% back", icon: "/icons/crypto/tron.svg", iconBg: "bg-red-50" },
                    { name: "Ethereum", rate: "Up to 3% back", icon: "/icons/crypto/ethereum.svg", iconBg: "bg-slate-100" },
                    { name: "BSC", rate: "Up to 2% back", icon: "/icons/crypto/bsc.svg", iconBg: "bg-amber-50" },
                    { name: "Polygon", rate: "Up to 4% back", icon: "/icons/crypto/polygon.svg", iconBg: "bg-purple-50" },
                  ].map((coin) => (
                    <div
                      key={coin.name}
                      className="card-surface flex flex-col items-start rounded-[28px] px-5 py-6 text-left sm:rounded-[32px] sm:px-6 sm:py-7"
                    >
                      <div className={`mb-4 flex h-12 w-12 items-center justify-center rounded-2xl ${coin.iconBg}`}>
                        <Image src={coin.icon} alt={coin.name} width={28} height={28} className="h-7 w-7" />
                      </div>
