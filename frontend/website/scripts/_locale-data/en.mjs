  ...
  return {
    ...
    home: {
      ...
      rewards: {
        ...
        categories: [
          { percent: "3%", label: "Dining & Travel" },
          { percent: "2%", label: "Online Shopping" },
          { percent: "1%", label: "Everything Else" },
        ],
        coins: [
          { name: "Tron", rate: "Up to 3% back" },
          { name: "Ethereum", rate: "Up to 3% back" },
          { name: "BSC", rate: "Up to 2% back" },
          { name: "Polygon", rate: "Up to 4% back" },
        ],
        maxLabel: "MAX",
      },
      premium: {
    ...
    footer: {
      ...
      social: [
        { label: "Facebook", followText: "Follow us on Facebook", href: "#" },
        { label: "GitHub", followText: "Follow us on GitHub", href: "#" },
        {
          label: "Instagram",
          followText: "Follow us on Instagram",
          href: "#",
        },
        { label: "X (Twitter)", followText: "Follow us on X", href: "#" },
        { label: "Reddit", followText: "Join us on Reddit", href: "#" },
        { label: "Telegram", followText: "Join us on Telegram", href: "#" },
        { label: "LinkedIn", followText: "Follow us on LinkedIn", href: "#" },
      ...
      download: {
        ...
        items: [
          ...
          { label: "Download APK", iconAlt: "Android" },
          { label: "Download for Android", iconAlt: "Google Play" },
        ],
      },
      ...
      licensedIssuer: { title: "Licensed Card Issuer" },
