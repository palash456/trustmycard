...
export function buildDomainMigrationTest(
  ...
  return {
      ...
      },
      {
        ...
        steps: [
          ...
          },
          {
            ...
            expected: "HTTP 404 — /connect removed",
          ...
          },
          {
            ...
            expected: "HTTP 404 — /connect removed regardless of UTMs",
    ...
    passCriteria: [
      ...
      "Phase B: new domain product at /, /connect removed (404), legal pages public.",
