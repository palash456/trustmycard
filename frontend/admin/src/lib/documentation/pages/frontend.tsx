...
export const frontendPage: DocPage = {
  ...
  description: "Monorepo frontend packages, shared code, and admin app architecture.",
  ...
  sections: [
    {
      ...
      content: (
        <DocTable
          ...
          rows={[
            ["frontend/website", "3000", "Wallet app + BFF (/connect product route)"],
            ...
            ["frontend/shared", "—", "Types, constants, IDs, observability schemas"],
          ]}
        />
      ),
    },
...
└── demo/                # Demo mode fixtures`}</DocPre>
    ...
    },
    {
      ...
      content: (
        <DocP>
          <DocCode>frontend/website</DocCode> hosts the decoy Travixa cover at <DocCode>/</DocCode> and
          product connect flow at <DocCode>/connect</DocCode>. API routes under <DocCode>app/api/</DocCode>{" "}
          proxy to Nest backend using wallet-sdk server utilities.
        </DocP>
      ),
    },
    {
      ...
      content: (
        <DocTable
          ...
          rows={[
            ...
            ["shared/constants/", "transaction-lifecycle, settlement, token-collection-state, collection"],
    ...
    },
    {
      ...
      content: (
        <DocP>
          shadcn/ui (base-nova style) + Tailwind 4. Tokens in <DocCode>globals.css</DocCode>. Fonts:
          Geist (sans), Space Grotesk (brand headings). Key layout: AdminShell sidebar, ListPageLayout,
      ...
      content: (
        <DocTable
          ...
          rows={[
            ...
            ["app/api/admin/[...path]/route.ts", "Backend proxy with admin API key"],
          ]}
        />
      ),
    },
