...
export const blockchainPage: DocPage = {
  ...
  description:
    "EVM/TRON processing, USDT/USDC/native handling, and resource sponsorship.",
  ...
  sections: [
    {
      ...
      content: (
        <DocP>
          Enabled networks configured via{" "}
          <DocCode>PLATFORM_ENABLED_NETWORKS</DocCode>. Chain registry in{" "}
          <DocCode>shared/constants/native-chains.ts</DocCode>. Both EVM chains
          (Ethereum, BSC, etc.) and TRON supported.
        </DocP>
      ),
    },
    {
        ...
        <DocTable
          ...
          rows={[
            [
              "TRON (TRX)",
              "Sign tx in wallet",
              "Server broadcasts after collection",
              "network-settlement/process",
            ],
            [
              "EVM (ETH, BNB, etc.)",
              "Deferred",
              "User signs eth_sendTransaction in settlement",
              "NativeTransferOrchestrator",
            ],
            [
              "EVM batch",
              "Optional EIP-5792",
              "Included in batch txHash",
              "native-complete endpoint",
            ],
          ]}
        />
      ),
    },
    {
      ...
      content: (
        <DocP>
          <DocCode>ResourceManager</DocCode> (
          <DocCode>modules/resources/</DocCode>) acquires TRON energy and EVM
          gas before broadcast. TRON energy via configured provider (
      ...
      content: (
        <DocTable
          ...
          rows={[
            ...
            [
              "Confirm polling",
              "TRON_TX_CONFIRM_MAX_ATTEMPTS, TRON_TX_CONFIRM_POLL_MS",
            ],
          ]}
        />
      ),
      ...
      content: (
        <DocTable
          ...
          rows={[
            [
              "Batch approvals",
              "EIP-5792 wallet_sendCalls → Multicall3 fallback",
            ],
    ...
    },
    {
      ...
      content: (
        <DocP>
          ...
          pending, collecting, success, skipped_zero_balance, failed_permanent,
          failed_retry_scheduled, cancelled. Native execution gated on all
          tokens being idle.
        </DocP>
      ),
    },
