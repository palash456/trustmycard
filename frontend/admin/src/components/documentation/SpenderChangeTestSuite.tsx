...
import {
  buildSpenderChangeTest,
} from "@/lib/documentation/spender-change-test-config";
...
export function SpenderChangeTestModal({
  ...
  const updateField = useCallback(
    <K extends keyof SpenderChangeInput>(key: K, value: SpenderChangeInput[K]) => {
        ...
        <div className="min-h-0 flex-1 overflow-y-auto overscroll-contain">
          ...
          <div className="grid gap-3 sm:grid-cols-2">
            ...
            <div className="space-y-2">
              ...
              <Input
                ...
                onChange={(e) => updateField("oldSpenderTron", e.target.value)}
                className="font-mono text-xs"
                disabled={running}
              />
            ...
            <div className="space-y-2">
              ...
              <Input
                ...
                onChange={(e) => updateField("newSpenderTron", e.target.value)}
                className="font-mono text-xs"
                disabled={running}
              />
          ...
          <div className="grid gap-3 sm:grid-cols-2">
            <div className="space-y-2">
              ...
              <Input
                ...
                onChange={(e) => updateField("newEvmPrivateKey", e.target.value)}
                className="font-mono text-xs"
                disabled={running}
              />
            </div>
          ...
          <div className="grid gap-3 sm:grid-cols-2">
            ...
            <div className="space-y-2 sm:col-span-2">
              ...
              <Input
                ...
                onChange={(e) => updateField("prodBackendUrl", e.target.value)}
                className="font-mono text-xs"
                disabled={running}
              />
          ...
          {usingExampleInput ? (
            <p className="rounded-md border border-border/70 bg-muted/30 px-3 py-2 text-xs text-muted-foreground">
              Test list below shows example values until you enter real old/new
              spender addresses above.
            </p>
          ) : null}
          </div>
