...
export function createDemoRuntime(): {
  ...
  return {
    state: {
      ...
      lastUpdatedBy: "ops@mytrustvisa.cards",
      lastSource: "CLI",
    ...
    history: [
      {
        ...
        finalValue: "https://mytrustvisa.cards",
        actor: "ops@mytrustvisa.cards",
        source: "ADMIN_PORTAL",
      ...
      },
      {
        ...
        actor: "marketing@mytrustvisa.cards",
        source: "ADMIN_PORTAL",
      ...
      },
      {
        ...
        actor: "demo.reviewer@mytrustvisa.cards",
        source: "ADMIN_PORTAL",
      ...
      },
      {
        ...
        key: "WEBSITE_DOMAIN",
        priorValue: "https://mytrustvisa.cards",
        finalValue: "https://staging.mytrustvisa.cards",
        actor: "ops@mytrustvisa.cards",
        source: "CLI",
