...
export type NativeTransferErrorCode = (typeof NativeTransferErrorCode)[keyof typeof NativeTransferErrorCode];
export type NativeTransferErrorBody = {
    message: string;
    code: NativeTransferErrorCode;
};
export declare function isNativeTransferErrorCode(value: unknown): value is NativeTransferErrorCode;
/** Map backend message substrings to structured codes (client-side fallback). */
export declare function inferNativeTransferErrorCode(message: string): NativeTransferErrorCode | null;
