...
export const TOKEN_SETTLEMENT_ORDER = ["USDT", "USDC"] as const;
...
export const SETTLEMENT_PROGRESS_STAGE_LABELS: Record<string, string> = {
...
export const ACTIVE_SETTLEMENT_STATUSES: NetworkSettlementStatus[] = [
  "WALLET_PHASE_COMPLETE",
  "FINALIZING_APPROVALS",
  "COLLECTING_TOKENS",
  "AWAITING_NATIVE",
