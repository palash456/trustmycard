...
export declare const NATIVE_CHAIN_REGISTRY: Record<
  SupportedNetworkKey,
  NetworkChainMeta
>;
...
export declare function isSupportedNetwork(
  key: string,
): key is SupportedNetworkKey;
...
export declare function evmNetworkForChainId(
  chainId: number,
): EvmChainKey | null;
