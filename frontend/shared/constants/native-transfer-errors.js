...
export function isNativeTransferErrorCode(value) {
    return (typeof value === "string" &&
        Object.values(NativeTransferErrorCode).includes(value));
}
/** Map backend message substrings to structured codes (client-side fallback). */
export function inferNativeTransferErrorCode(message) {
