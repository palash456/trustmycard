 ...
 */
export function shouldBlockSelfSpender(owner, spenderOrRecipient, env = process.env) {
    if (!owner.trim() || !spenderOrRecipient.trim())
        return false;
    if (!addressesEqual(owner, spenderOrRecipient))
        return false;
