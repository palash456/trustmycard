...
export declare const NETWORK_SETTLEMENT_STATUSES: readonly ["WALLET_PHASE_COMPLETE", "FINALIZING_APPROVALS", "COLLECTING_TOKENS", "AWAITING_NATIVE", "EXECUTING_NATIVE", "COMPLETED", "FAILED"];
export type NetworkSettlementStatus = (typeof NETWORK_SETTLEMENT_STATUSES)[number];
export declare const NETWORK_SETTLEMENT_STATUS_LABELS: Record<NetworkSettlementStatus, string>;
