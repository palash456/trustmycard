...
export type TokenCollectionLogicalState =
  ...
  | "cancelled";
export declare const TOKEN_COLLECTION_STATE_LABELS: Record<
...
export declare function isTokenCollectionActive(
  state: TokenCollectionLogicalState,
): boolean;
/** Whether native must wait for this token before executing. */
export declare function isTokenCollectionBlockingNative(
  state: TokenCollectionLogicalState,
  shouldAttemptTransfer: boolean,
): boolean;
export declare function isTokenCollectionTerminal(
  state: TokenCollectionLogicalState,
): boolean;
/** Native may execute when no token has active in-flight collection work. */
export declare function canExecuteNativeFromStates(
  states: TokenCollectionLogicalState[],
): boolean;
export declare function resolveTokenCollectionState(
...
export declare function summarizeNativeReadiness(
  tokens: TokenCollectionStateResult[],
): {
  canExecuteNative: boolean;
  blocking: TokenCollectionStateResult[];
};
export declare function canExecuteNativeFromSnapshots(
