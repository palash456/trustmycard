...
export declare function incrementCounter(name: string, labels?: MetricLabels, delta?: number): void;
export declare function recordTiming(name: string, durationMs: number, labels?: MetricLabels): void;
