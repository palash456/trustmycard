...
export declare function buildSamplingKey(parts: Record<string, unknown>): string;
export declare class LogSampler {
    ...
    shouldEmit(level: LogLevel, module: string, keyParts: Record<string, unknown>): SamplingDecision;
