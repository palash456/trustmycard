...
const DEFAULT_POLICY: Record<LogLevel, SamplingPolicy> = {
...
export function buildSamplingKey(parts: Record<string, unknown>): string {
...
export class LogSampler {
  ...
  private resolvePolicy(level: LogLevel, module: string): SamplingPolicy {
